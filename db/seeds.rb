...
kenn = Place.create(name: "Kennebunk", location: 37, description: "Kennebunk and its close neighbor, Kennebunkport, are filled with historic charm, fishwing wharfs, unique boutiques, and some delicious restaurants.", image: "https://vacationidea.com/pix/img25Hy8R/articles/best-things-to-do-in-kennebunkport-me_t5.jpg")
...
dama = Place.create(name: "Damariscotta", location: 126)
camd = Place.create(name: "Camden", location: 184)
orla = Place.create(name: "Orland", location: 232)
ells = Place.create(name: "Ellsworth", location: 248)
cala = Place.create(name: "Calais", location: 352)
